...
<html>
    ...
    <body style="background:lightblue;">
		...
		<ul class="nav navbar-nav">
			 <li class="active"><a href="index.html"><span class="glyphicon glyphicon-log-out"></span> logout</a></li>
       ...
       <div class="container">
            <div class="row">
                <div class="col-md-4" style="padding:10px;background:#fff;border-radius: 5px;" id="divvideo">
                    ...
                    <video id="preview" width="80%" height="40%" style="border-radius:10px;"></video>
					<br>
					<br>
					<?php
				...
				<div align="center"><img src="img\cot1.png"  width ="4%"></a>
					<h6>The Rebublic of Zambia</h6>
				<h4>Ministry of Home Affars</h4>
			</div>
<div align="center">  <img src="img\7.png"  width =" 9%" >
		<h3> Zambia Police Service </h3>
		<h4> QR Code Login System </h4>
